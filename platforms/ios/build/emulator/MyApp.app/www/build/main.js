...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_native_contacts__ = __webpack_require__(246);
...
var HomePage = (function () {
    function HomePage(navCtrl, params, firebaseAnalytics, loadingCtrl, geolocation, contacts) {
    ...
    HomePage.prototype.buttonClick = function () {
        var _this = this;
        this.contact.name = new __WEBPACK_IMPORTED_MODULE_4__ionic_native_contacts__["b" /* ContactName */](null, 'Smith', 'John');
        this.contact.phoneNumbers = [new __WEBPACK_IMPORTED_MODULE_4__ionic_native_contacts__["a" /* ContactField */]('mobile', '6471234567')];
        this.contact.save().then(function () { return console.log('Contact saved!', _this.contact); }, function (error) { return console.error('Error saving contact.', error); });
    };
    return HomePage;
}());
__decorate([
